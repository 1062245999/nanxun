...
export const infoWindowStyle: string = `width: 62.933vw;position:relative;display: flex;flex-direction: row;background: red;background: white;padding: 2.133vw;border-radius: 1.067vw;`;
